...
public class StockAPIService {
    ...
    private static final String allStocksPath = "https://run.mocky.io/v3/9e14e086-84c2-4f98-9e36-54928830c980";

    private final UrlReader remoteURLReader;

    @Autowired
    public StockAPIService(UrlReader remoteURLReader) {
    ...
    public String listStocks() throws IOException, JSONException {
        String result = remoteURLReader.readFromUrl(allStocksPath);
        JSONObject json = new JSONObject(result);
